...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString* imageToLoad = [NSString stringWithFormat:@"res_%ld.png",(long)indexPath.row+ 1];
...
#pragma mark --UICollectionViewDelegateFlowLayout
 ...
 {
     if (indexPath.item == 0) {
         return CGSizeMake(300*SCREEN_WIDTH/320.0f, 110*SCREEN_WIDTH/320.0f);
     }else if(indexPath.item == 7 || indexPath.item == 8)
     {
         return CGSizeMake(145*SCREEN_WIDTH/320.0f, 190*SCREEN_WIDTH/320.0f);
     }else
     {
         return CGSizeMake(145*SCREEN_WIDTH/320.0f, 90*SCREEN_WIDTH/320.0f);
     }
 }
 ...
 {
     return UIEdgeInsetsMake(10*SCREEN_WIDTH/320.0f, 10*SCREEN_WIDTH/320.0f, 10*SCREEN_WIDTH/320.0f, 10*SCREEN_WIDTH/320.0f);
 }
